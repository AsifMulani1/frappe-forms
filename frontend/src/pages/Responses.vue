        ...
        <div class="record-drawer" v-if="drawer">
          ...
          <div class="flex-1 overflow-y-auto p-4">
            ...
            <div v-if="drawer.encrypted" class="mb-4 rounded-md border border-outline-gray-1 bg-surface-gray-1 p-3 flex items-center gap-2.5">
              <Icon :name="unlocked ? 'shield-check' : 'lock'" :size="15" :class="unlocked ? 'text-ink-green-6' : 'text-ink-gray-5'" />
            ...
            <div class="flex items-start gap-2 mt-5">
              <Icon name="shield-check" :size="14" class="text-ink-green-6 mt-px shrink-0" />
    ...
    <Dialog v-model="unlockOpen" :options="{ title: 'Unlock responses' }">
      <template #body-content>
        <div class="flex flex-col gap-4">
          ...
          <span v-if="unlockErr" class="text-xs text-ink-red-6 flex items-center gap-1">
